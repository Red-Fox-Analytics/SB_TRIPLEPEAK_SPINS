...
select   	"Product Level" as PRODUCT_LEVEL,"Category" as CATEGORY,"Subcategory" SUBCATEGORY,"FLAVOR" as FLAVOR, "Channel/Outlet" CHANNEL_OUTLET,"Retail Account Level" RETAIL_ACCOUNT_LEVEL,"Brand" BRAND, "Product Universe" PRODUCT_UNIVERSE, "UPC" UPC,"Description" as PRODUCT_DESCRIPTION
	...
	group by "Product Level","Category","Subcategory","FLAVOR","Channel/Outlet","Retail Account Level","Brand" , "Product Universe" , "UPC" ,"Description"
